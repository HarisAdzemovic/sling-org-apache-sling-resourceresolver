...
import NonExistingResource.RESOURCE_TYPE_NON_EXISTING;
...
public abstract class ResourceDecoratorTestBase {
    ...
    protected void assertExistent(Resource r, boolean existent) {
        ...
        assertEquals(("Expecting " + (existent ? "existent" : "non-existent")) + " resource", existent, !RESOURCE_TYPE_NON_EXISTING.equals(r.getResourceType()));
    }
