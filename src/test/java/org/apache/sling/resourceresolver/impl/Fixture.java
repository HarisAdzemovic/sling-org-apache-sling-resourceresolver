...
public class Fixture {
    ...
    public ResourceProviderInfo registerResourceProvider(ResourceProvider<?> rp, String root, AuthType authType, int serviceRanking) throws InvalidSyntaxException {
        Dictionary<String, Object> props = new Hashtable<>();
        props.put(PROPERTY_ROOT, root);
        props.put(PROPERTY_AUTHENTICATE, authType.name());
        props.put(PROPERTY_MODIFIABLE, Boolean.TRUE.toString());
        if (serviceRanking != 0) {
