...
public class ResourceProviderStorageTest {
    ...
    public void testAdaptableOrdering() throws Exception {
        ...
        when(r1.getProperty(PROPERTY_ADAPTABLE)).thenReturn(Boolean.TRUE);
        final ServiceReference r2 = mock(ServiceReference.class);
        when(r2.getProperty(PROPERTY_ADAPTABLE)).thenReturn(Boolean.TRUE);
        final ServiceReference r3 = mock(ServiceReference.class);
        when(r3.getProperty(PROPERTY_ADAPTABLE)).thenReturn(Boolean.TRUE);
