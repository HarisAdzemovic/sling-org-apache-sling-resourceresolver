...
public class ResourceMapperImplTest {
    ...
    public void prepare() throws LoginException {
        ...
        resourceProvider.putResource("/etc/map/http/localhost_any", "sling:internalRedirect", "/somewhere", "sling:match", "localhost.8080/everywhere");
        ...
        ctx.registerInjectActivateService(new ResourceResolverFactoryActivator(), "resource.resolver.optimize.alias.resolution", false);
    ...
    public void mapNonExistingPath() throws LoginException {
        ExpectedMappings.nonExistingResource("/not-here").singleMapping("/not-here").singleMappingWithRequest("/app/not-here").allMappings("/not-here").allMappingsWithRequest("/app/not-here").verify(resolver, req);
    }
    ...
    public void mapExistingPath() throws LoginException {
        ExpectedMappings.existingResource("/here").singleMapping("/here").singleMappingWithRequest("/app/here").allMappings("/here").allMappingsWithRequest("/app/here").verify(resolver, req);
    }
    ...
    public void mapResourceWithAlias() {
        ExpectedMappings.existingResource("/there").singleMapping("/alias-value").singleMappingWithRequest("/app/alias-value").allMappings("/alias-value", "/there").allMappingsWithRequest("/app/alias-value", "/app/there").verify(resolver, req);
    }
    ...
    public void mapResourceWithAliasAndEtcMap() {
        ExpectedMappings.existingResource("/somewhere").singleMapping("/alias-value-2").singleMappingWithRequest("/app/alias-value-2").allMappings("http://localhost:8080/everywhere", "/alias-value-2", "/somewhere").allMappingsWithRequest("/app/everywhere", "/app/alias-value-2", "/app/somewhere").verify(resolver, req);
    }
    ...
    public void mapResourceWithAliasOnParent() {
        ExpectedMappings.existingResource("/there/that").singleMapping("/alias-value/that").singleMappingWithRequest("/app/alias-value/that").allMappings("/alias-value/that", "/there/that").allMappingsWithRequest("/app/alias-value/that", "/app/there/that").verify(resolver, req);
    }
