...
public class ResourceResolverImplTest {
    ...
    public void test_clone_based_on_anonymous() throws Exception {
        ...
        admin0Cred.put(USER, "admin");
        admin0Cred.put(PASSWORD, "admin".toCharArray());
    ...
    public void test_attributes_from_authInfo() throws Exception {
        ...
        authInfo.put(USER, "admin");
        authInfo.put(PASSWORD, "admin".toCharArray());
        ...
        assertEquals("admin", rr.getAttribute(USER));
        assertNull(rr.getAttribute(PASSWORD));
    ...
    private static class SyntheticResourceWithSupertype extends SyntheticResource {
        ...
        public SyntheticResourceWithSupertype(ResourceResolver resourceResolver, String path, String resourceType, String resourceSuperType) {
