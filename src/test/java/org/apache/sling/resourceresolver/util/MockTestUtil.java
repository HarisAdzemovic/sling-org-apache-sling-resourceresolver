...
import ValueMapDecorator.EMPTY;
...
public class MockTestUtil {
     ...
     *
     * @param fullPath
     * 		Full / Aboslute path to the resource
     ...
     *
     * @param url
     * 		Absolute URL to be used to get the method, host and port
     ...
     * @param parent
     * 		Parent of this resource but it can be null
     * @param resourceResolver
     * 		Resource Resolver of this resource
     * @param provider
     * 		Resource Provider Instance
     * @param properties
     * 		Key / Value pair for resource properties (the number of strings must be even)
    ...
    public static Resource buildResource(String fullPath, Resource parent, ResourceResolver resourceResolver, ResourceProvider<?> provider, String... properties) {
        ...
        if (properties != null) {
            ...
            when(resource.getValueMap()).thenReturn(EMPTY);
            when(resource.adaptTo(Mockito.eq(ValueMap.class))).thenReturn(EMPTY);
        }
        return resource;
    }
     ...
     * 		If the call failed because it method is not found, has no access or invocation failed
     */
     ...
     * 		Target instance
     * @param paramsType
     * 		Parameter Type which cannot be null
     * @param param
     * 		Parameter Value
     * @return Object that is returned from the method call
     * @throws UnsupportedOperationException
     ...
     * 		Parameter Types which must not be null
     * @param parameters
     * 		Parameter Values which must not be null
     * @return Object that is returned from the method call
     * @throws IllegalArgumentException
     * 		If the parameter types and values do not match
     * @throws UnsupportedOperationException
     * 		If the call failed because it method is not found, has no access or invocation failed
     */
    ...
    public static class MethodWrapper<T> {
        ...
        public T call(Object... parameters) throws IllegalAccessException, InvocationTargetException {
     ...
     * 		Value to be set
     * @throws UnsupportedOperationException
     * 		If the call failed because it field is not found or has no access
     */
