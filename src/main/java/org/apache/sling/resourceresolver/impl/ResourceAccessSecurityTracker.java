 ...
 */
@Component(service = ResourceAccessSecurityTracker.class, property = { Constants.SERVICE_VENDOR + "=The Apache Software Foundation" })
public class ResourceAccessSecurityTracker {
    @Reference(policyOption = ReferencePolicyOption.GREEDY, cardinality = ReferenceCardinality.OPTIONAL, policy = ReferencePolicy.DYNAMIC, target = ((("(" + ResourceAccessSecurity.CONTEXT) + "=") + ResourceAccessSecurity.APPLICATION_CONTEXT) + ")")
    private volatile ResourceAccessSecurity applicationResourceAccessSecurity;

    @Reference(policyOption = ReferencePolicyOption.GREEDY, cardinality = ReferenceCardinality.OPTIONAL, policy = ReferencePolicy.DYNAMIC, target = ((("(" + ResourceAccessSecurity.CONTEXT) + "=") + ResourceAccessSecurity.PROVIDER_CONTEXT) + ")")
