...
public class ResourceDecoratorTracker {
     ...
     */
    public void bindResourceDecorator(final ResourceDecorator decorator, final Map<String, Object> props) {
        synchronized(this.resourceDecorators) {
            this.resourceDecorators.add(new ResourceDecoratorEntry(decorator, ServiceUtil.getComparableForServiceRanking(props)));
     ...
     */
    public void unbindResourceDecorator(final ResourceDecorator decorator, final Map<String, Object> props) {
        synchronized(this.resourceDecorators) {
