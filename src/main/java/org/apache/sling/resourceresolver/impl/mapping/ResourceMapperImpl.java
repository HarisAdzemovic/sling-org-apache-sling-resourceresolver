...
public class ResourceMapperImpl implements ResourceMapper {
    ...
    public ResourceMapperImpl(ResourceResolverImpl resolver, ResourceDecoratorTracker resourceDecorator, MapEntriesHandler mapEntries, boolean optimizedAliasResolutionEnabled, Object namespaceMangler) {
    ...
    private void populateMappingsFromMapEntries(List<String> mappings, String mappedPath, final RequestContext requestContext) {
    ...
    private class RequestContext {
        ...
        private RequestContext(HttpServletRequest request, String resourcePath) {
            if (request != null) {
                ...
                logger.debug("map: Mapping path {} for {} (at least with scheme prefix {})", new Object[]{ resourcePath, uri, schemeWithPrefix });
            } else {
                this.uri = null;
