...
public class ResourceResolverFactoryActivator {
    ...
    private void registerFactory(final BundleContext localContext) {
        ...
        if (localContext != null) {
            ...
            local.factoryRegistration = localContext.registerService(ResourceResolverFactory.class, new ServiceFactory<ResourceResolverFactory>() {
                @Override
                public ResourceResolverFactory getService(final Bundle bundle, final ServiceRegistration<ResourceResolverFactory> registration) {
                    ...
                    final ResourceResolverFactoryImpl r = new ResourceResolverFactoryImpl(local.commonFactory, bundle, ResourceResolverFactoryActivator.this.serviceUserMapper);
                    return r;
                }
            ...
            local.runtimeRegistration = localContext.registerService(RuntimeService.class, this.getRuntimeService(), null);
