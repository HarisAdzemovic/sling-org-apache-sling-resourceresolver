...
public class Mapping {
    ...
    public Mapping(String[] parts) {
        ...
        this.direction = (">".equals(parts[1])) ? Mapping.INBOUND : "<".equals(parts[1]) ? Mapping.OUTBOUND : Mapping.BOTH;
    }

    @Override
    public String toString() {
        return (((((((("Mapping (from=" + from) + ", to=") + to) + ", direction=") + direction) + ", lengths=") + fromLength) + "/") + toLength;
    }
