...
public class BasicObserverConfiguration implements ObserverConfiguration {
    ...
    public BasicObserverConfiguration(final PathSet paths, final Set<ChangeType> types, final boolean isExternal, final PathSet excludePaths, final Set<String> propertyNamesHint) {
    ...
    public BasicObserverConfiguration(final PathSet set) {
        ...
        types.add(PROVIDER_ADDED);
        types.add(PROVIDER_REMOVED);
        this.changeTypes = Collections.unmodifiableSet(types);
    ...
    public String toString() {
        ...
        return ((((((((((("BasicObserverConfiguration [includeExternal=" + includeExternal) + ", paths=") + paths) + ", excludedPaths=") + excludedPathsToString) + ", propertyNamesHint=") + propertyNamesHint) + ", changeTypes=") + changeTypes) + ", listeners=") + listeners) + "]";
    }
}